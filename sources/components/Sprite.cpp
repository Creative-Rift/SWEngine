...
{
    m_color = color;
    m_vertexArray[1].color = m_color.normalize();
    m_vertexArray[0].color = m_color.normalize();
    m_vertexArray[3].color = m_color.normalize();
    m_vertexArray[2].color = m_color.normalize();
    return (*this);
}
