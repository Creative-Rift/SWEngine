...
m_indices{0, 1, 3, 1, 2, 3}
{
    ...
    m_array.emplace_back(a, sw::WhiteColor.normalize());
    m_array.emplace_back(b, sw::WhiteColor.normalize());
    m_array.emplace_back(c, sw::WhiteColor.normalize());
    m_array.emplace_back(d, sw::WhiteColor.normalize());
}
